...
proc init_gui { IPINST } {
  ...
  set m [ipgui::add_param $IPINST -name "m"]
  set_property tooltip {Number of training samples} ${m}
  set n [ipgui::add_param $IPINST -name "n"]
  set_property tooltip {Number of features} ${n}
